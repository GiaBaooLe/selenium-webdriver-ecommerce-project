...
public class TC08 {
    ...
    public void testTC08(){
        String email = "bao1234@gmail.com";
        ...
        try {
            ...
            driver.findElement(By.xpath("(//a[@class='link-reorder'][normalize-space()='Reorder'])[2]")).click();
            Thread.sleep(2000);
            ...
            String grandTotal = driver.findElement(By.xpath("(//td[@class='a-right'])[1]")).getText();
