...
public class TC05 {
    ...
    public void testTC05() {
        ...
        String firstName = "le";
        String lastName = "bao";
        String email_address = "bao1234@gmail.com";
        String password = "bao123";
        String confirmPassword = "bao123";
        ...
        try {
            ...
            emailInput.clear();
            emailInput.sendKeys("bao1234@gmail.com");
            ...
            String png = ("D:\\selenium-webdriver-java-master\\src\\test\\resources\\png/TC05_" + scc + ".png");
